...
class ChampionshipsControllerTest < ActionController::TestCase
  ...
  test "should create championship" do
    assert_difference('Championship.count') do
      post :create, championship: { Loses: @championship.Loses, TeamName: @championship.TeamName, Team_id: @championship.Team_id, Wins: @championship.Wins, Year: @championship.Year }
    end
  ...
  test "should update championship" do
    put :update, id: @championship, championship: { Loses: @championship.Loses, TeamName: @championship.TeamName, Team_id: @championship.Team_id, Wins: @championship.Wins, Year: @championship.Year }
    assert_redirected_to championship_path(assigns(:championship))
  end
